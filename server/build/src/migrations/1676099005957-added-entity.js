...
exports.addedEntity1676099005957 = void 0;
class addedEntity1676099005957 {
    constructor() {
        this.name = 'addedEntity1676099005957';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "users" ("created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "email" character varying NOT NULL, "contact_number" bigint NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', "password" character varying, "change_password_token" character varying, "last_login_at" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_463c7b876dd0e8d3803c72af152" UNIQUE ("contact_number"), CONSTRAINT "UQ_463c7b876dd0e8d3803c72af152" UNIQUE ("contact_number"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE INDEX "email_index" ON "users" ("email") `);
            yield queryRunner.query(`CREATE TABLE "products" ("created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "category" "public"."products_category_enum" NOT NULL DEFAULT 'OTHERS', "img_url" text, "description" text, "additional_remarks" text, "is_available" boolean DEFAULT true, "sell_time" TIMESTAMP, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "recycle" ("created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "name" character varying NOT NULL, "category" "public"."recycle_category_enum" NOT NULL, "remarks" text, "img_url" text, "is_pickedup" boolean DEFAULT true, "recycle_pickup_time" TIMESTAMP, CONSTRAINT "PK_57cf57949a58c13f3cd7612cb45" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "carpool_details" ("created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "publisher_id" uuid NOT NULL, "name" character varying, "estimated_price" integer NOT NULL, "additional_remarks" text, "departure_time" TIMESTAMP NOT NULL, "capacity" integer NOT NULL, "rider_count" integer NOT NULL, "publisher_rider_count" integer NOT NULL, "destination" text NOT NULL, "source" text NOT NULL, "mapping" text, "is_completed" boolean DEFAULT false, CONSTRAINT "PK_c66f02ddbbe7bc5ca34950f8b3c" PRIMARY KEY ("id"))`);
...
exports.addedEntity1676099005957 = addedEntity1676099005957;
